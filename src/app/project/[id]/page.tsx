            ...
            <div className="bg-gradient-to-br from-amber-50/80 to-orange-50/80 backdrop-blur-sm border-b border-amber-100/50 p-8">
              <div className="max-w-3xl mx-auto">
                ...
                <div className="text-center mt-8">
                  <button
                    onClick={() => router.push(`/project/${project.id}/attendance`)}
                    className="inline-flex items-center gap-2 bg-gradient-to-r from-amber-500 to-orange-500 text-white px-8 py-3.5 rounded-full text-base font-bold shadow-lg hover:shadow-xl hover:from-amber-600 hover:to-orange-600 transition-all duration-200 transform hover:scale-105"
                  >
